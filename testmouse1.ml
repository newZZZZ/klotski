...
let getmouse x y ls=
	...
	if (x>=30*ratiox&&x<=130*ratiox&&y>=30*ratioy&&y<=130*ratioy) then check_moveable 0 ls
	else if  (x>=140*ratiox&&x<=240*ratiox&&y>=30*ratioy&&y<=130*ratioy) then check_moveable 1 ls 
	else if  (x>=250*ratiox&&x<=350*ratiox&&y>=30*ratioy&&y<=130*ratioy) then check_moveable 2 ls
	else if  (x>=360*ratiox&&x<=460*ratiox&&y>=30*ratioy&&y<=130*ratioy) then check_moveable 3 ls
	else if  (x>=30*ratiox&&x<=130*ratiox&&y>=140*ratioy&&y<=240*ratioy) then check_moveable 4 ls
	else if  (x>=140*ratiox&&x<=240*ratiox&&y>=140*ratioy&&y<=240*ratioy) then check_moveable 5 ls
	else if  (x>=250*ratiox&&x<=350*ratiox&&y>=140*ratioy&&y<=240*ratioy) then check_moveable 6 ls
	else if  (x>=360*ratiox&&x<=460*ratiox&&y>=140*ratioy&&y<=240*ratioy) then check_moveable 7 ls
	else if  (x>=30*ratiox&&x<=130*ratiox&&y>=250*ratioy&&y<=350*ratioy) then check_moveable 8 ls
	else if  (x>=140*ratiox&&x<=240*ratiox&&y>=250*ratioy&&y<=350*ratioy) then check_moveable 9 ls
	else if  (x>=250*ratiox&&x<=350*ratiox&&y>=250*ratioy&&y<=350*ratioy) then check_moveable 10 ls
	else if  (x>=360*ratiox&&x<=460*ratiox&&y>=250*ratioy&&y<=350*ratioy) then check_moveable 11 ls
	else if  (x>=30*ratiox&&x<=130*ratiox&&y>=360*ratioy&&y<=460*ratioy) then check_moveable 12 ls
	else if  (x>=140*ratiox&&x<=240*ratiox&&y>=360*ratioy&&y<=460*ratioy) then check_moveable 13 ls
	else if  (x>=250*ratiox&&x<=350*ratiox&&y>=360*ratioy&&y<=460*ratioy) then check_moveable 14 ls
	else if  (x>=360*ratiox&&x<=460*ratiox&&y>=360*ratioy&&y<=460*ratioy) then check_moveable 15 ls
	else if  (x>=30*ratiox&&x<=130*ratiox&&y>=470*ratioy&&y<=570*ratioy) then check_moveable 16 ls
	else if  (x>=140*ratiox&&x<=240*ratiox&&y>=470*ratioy&&y<=570*ratioy) then check_moveable 17 ls
	else if  (x>=250*ratiox&&x<=350*ratiox&&y>=470*ratioy&&y<=570*ratioy) then check_moveable 18 ls
	else if  (x>=360*ratiox&&x<=460*ratiox&&y>=470*ratioy&&y<=570*ratioy) then check_moveable 19 ls    
	else ls 
...
let () =
  ...
  let rec loop ls=
    ...
    let e=Graphics.wait_next_event [Button_down] in     
		let new_ls=getmouse e.mouse_x e.mouse_y ls in 
    (* call the loop again *)
   	loop new_ls
  in
